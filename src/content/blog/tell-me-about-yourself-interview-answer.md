...
description: "Learn how to answer Tell me about yourself with a clear framework, realistic examples, and voice practice so you sound confident—not scripted."
---
...
| --- | --- | --- |
| **Present** | ~20s | Who you are professionally *today* |
| **Past** | ~40s | 1–2 proof points that support this role |
| **Future** | ~20s | Why *this* team, *this* problem, now |
...
1. **Starting too early** — elementary school is almost never relevant.
2. **Reciting the résumé** — they have the PDF; add narrative, not lists.
3. **No bridge to the role** — always land the last sentence on *their* problem.
4. **Monotone delivery** — energy should rise slightly on “why this role.”
...
**Present:** role + specialty  
**Past:** 2 outcomes with numbers  
**Future:** why them + what you’ll contribute  
