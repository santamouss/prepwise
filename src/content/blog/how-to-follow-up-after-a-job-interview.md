...
keywords: "how to follow up after job interview, thank you email after interview"
author: "Parker Team"
description: "Learn how to follow up after a job interview with thank-you email templates, timing rules, and scripts for recruiters and hiring managers."
---
...
1. **Gratitude** — You respect their time and the process.
2. **Clarity** — You reinforce one or two points that matter for the role.
3. **Continuity** — You make it easy for them to remember you among parallel candidates.
...
|-----------|-------------------|
| After any interview round | Thank-you within **24 hours** (same day is fine if evening) |
| Recruiter said "we'll decide by Friday" | Wait until **end of Friday** in their timezone, then one polite check-in |
| No timeline given | **5–7 business days** after last contact |
| After final round | Thank-you within 24 hours; wait **7–10 business days** before a second nudge unless told otherwise |
| They said "we'll be in touch" | One follow-up at 7 business days, then pause |
...
1. **Thank them** for their time (one sentence).
2. **Reference one specific moment** from the conversation (shows you listened).
3. **Reinforce one fit point** with a short proof line—not a new essay.
4. **Close forward** — enthusiasm, availability, or offer to provide anything else.

### Sample thank-you (hiring manager, behavioral round)
